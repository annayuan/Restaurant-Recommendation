...
public class DBImport {
	public static void main(String[] args) {
		try {
			...
			stmt.executeUpdate(sql); // just update, don't read or return
										// anything.
			sql = "DROP TABLE IF EXISTS USERS";
			stmt.executeUpdate(sql);
			sql = "DROP TABLE IF EXISTS RESTAURANTS";
			stmt.executeUpdate(sql);
			// every time when write something, need to execute update.
			...
			BufferedReader reader = new BufferedReader(
					new FileReader(
							"/Users/AnnaY/Documents/UCLA/OhWork/laioffer/"
							+ "LaiofferProj/Project/yelp_dataset-master/business_small.json"));
